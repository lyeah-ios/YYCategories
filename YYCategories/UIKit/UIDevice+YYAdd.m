...
- (NSString *)machineModelName {
    ...
    dispatch_once(&one, ^{
        ...
        NSDictionary *dic = @{
            ...
            @"iPod2,1"   : @"iPod Touch 2",      // (2 Gen)
            @"iPod3,1"   : @"iPod Touch 3",      // (3 Gen)
            @"iPod4,1"   : @"iPod Touch 4",      // (4 Gen)
            @"iPod5,1"   : @"iPod Touch 5",      // (5 Gen)
            @"iPod7,1"   : @"iPod Touch 6",      // (6 Gen)
            @"iPod9,1"   : @"iPod Touch 7",      // (7 Gen)
            ...
            @"iPad2,3"   : @"iPad 2",          // (CDMA)
            @"iPad2,4"   : @"iPad 2",          //
            @"iPad2,5"   : @"iPad Mini",       // (Original) (WiFi)
            @"iPad2,6"   : @"iPad Mini",       //
            @"iPad2,7"   : @"iPad Mini",       // (GSM+CDMA)
            @"iPad3,1"   : @"iPad 3",          // (3rd Generation) (WiFi)
            @"iPad3,2"   : @"iPad 3",          // (GSM+CDMA)
            @"iPad3,3"   : @"iPad 3",          //
            @"iPad3,4"   : @"iPad 4",          // (4th Generation) (WiFi)
            @"iPad3,5"   : @"iPad 4",          //
            ...
            @"iPad5,3"   : @"iPad Air 2",      //
            @"iPad5,4"   : @"iPad Air 2",      //
            @"iPad6,3"   : @"iPad Pro",        // iPad Pro 9.7
            @"iPad6,4"   : @"iPad Pro",        // iPad Pro 9.7
            @"iPad6,7"   : @"iPad Pro",        // iPad Pro 12.9
            @"iPad6,8"   : @"iPad Pro",        // iPad Pro 12.9
            @"iPad6,11"  : @"iPad 5",          // iPad 5 (WiFi)
            @"iPad6,12"  : @"iPad 5",          // iPad 5 (Cellular)
            @"iPad7,1"   : @"iPad Pro",        // iPad Pro 12.9 inch 2nd gen (WiFi)
            @"iPad7,2"   : @"iPad Pro",        // iPad Pro 12.9 inch 2nd gen (Cellular)
            @"iPad7,3"   : @"iPad Pro",        // iPad Pro 10.5 inch (WiFi)
            @"iPad7,4"   : @"iPad Pro",        // iPad Pro 10.5 inch (Cellular)
            @"iPad7,5"   : @"iPad 6",          // iPad 6 (WiFi)
            @"iPad7,6"   : @"iPad 6",          // iPad 6 (Cellular)
            @"iPad8,1"   : @"iPad Pro",        // iPad Pro 11
            @"iPad8,2"   : @"iPad Pro",        // iPad Pro 11
            @"iPad8,3"   : @"iPad Pro",        // iPad Pro 11
            @"iPad8,4"   : @"iPad Pro",        // iPad Pro 11
            @"iPad8,5"   : @"iPad Pro",        // iPad Pro 12.9 inch 3rd gen
            @"iPad8,6"   : @"iPad Pro",        // iPad Pro 12.9 inch 3rd gen
            @"iPad8,7"   : @"iPad Pro",        // iPad Pro 12.9 inch 3rd gen
            @"iPad8,8"   : @"iPad Pro",        // iPad Pro 12.9 inch 3rd gen
            @"iPad11,1"  : @"iPad Mini 5",     // iPad Mini 5th
            @"iPad11,2"  : @"iPad Mini 5",     // iPad Mini 5th
            @"iPad11,3"  : @"iPad Air 3",      // iPad Air 3rd gen
            @"iPad11,4"  : @"iPad Air 3",      // iPad Air 3rd gen
